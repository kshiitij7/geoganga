...
export default {
    ...
    data() {
        return {
            ...
            cards: [
                    {title: "Ganga Basin", icon: "mdi-leaf", text: "Content about the Ganga Basin goes here. ",},
                    {title: "Water Quality", icon: "mdi-water-check", text: "Content about water quality goes here.",},
                    {title: "Flood Hazard", icon: "mdi-alert", text: "Content about flood hazard goes here.",},
                    {title: "Solid Waste", icon: "mdi-recycle", text: "Content about solid waste management goes here.",},
                ],
            currentCardIndex: 0,
        };
